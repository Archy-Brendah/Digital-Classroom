# Generated by Django 2.1.3 on 2019-06-10 19:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('msg', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myFile.Message')),
            ],
        ),
        migrations.CreateModel(
            name='StudentAnswer',
        ...
        migrations.AddField(
            model_name='comms',
            name='subject',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myFile.Subject'),
        ),
        migrations.AddField(
            model_name='book',
            name='Period',
